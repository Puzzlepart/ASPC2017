...
function DisplayTemplate_36962f047ad44007ade27b78ea8013e5(ctx) {
    ...
    if (siteLink.indexOf('personal') === -1) {
        ms_outHtml.push(''
            , '                        <div class="pzl-contract-yes" onClick="Pzl.Discover.DiscoverTask(\'Classify &quot;', title, '&quot; as mission\', \'', linkURL, '\', \'', loginName, '\', \'', containerId, '\', \'', workId, '\', \'', editLink, '\');&#160;" title="Add task to classify as contract">'
            , '                            <span class="material-icons">thumb_up</span>'
            , '                        </div>'
        );
    } else {
        ms_outHtml.push(''
            , '                        <div class="pzl-contract-yes" onClick="Pzl.Discover.DiscoverTask(\'Move &quot;', title, '&quot; and classify as mission\', \'', linkURL, '\', \'', loginName, '\', \'', containerId, '\', \'', workId, '\', \'', editLink, '\');&#160;" title="Add task to move and classify as contract">'
            , '                            <span class="material-icons">thumb_up</span>'
            , '                        </div>'
        );
    }
