...
<asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    <link rel="stylesheet" type="text/css" href="/sites/pzl-CDN/SiteAssets/CDN/css/projectportal.css?rev=20161124-1" >
    <script type="text/javascript" src="/sites/pzl-CDN/SiteAssets/CDN/libs/js/jquery.min.js"></script>
    <script type="text/javascript" src="/sites/pzl-CDN/SiteAssets/CDN/js/resources.js?rev=20161124-1"></script>
</asp:Content>
...
<WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" Title="<%$Resources:cms,WebPartZoneTitle_Left%>" ID="LeftColumn"
    Orientation="Vertical" /> &#160;
</td>
<td valign="top" width="29%" class="right-zone">
    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" Title="<%$Resources:cms,WebPartZoneTitle_Right%>" ID="RightColumn"
        Orientation="Vertical" /> &#160;
</td>
<td>&#160;</td>
</tr>
